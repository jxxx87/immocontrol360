-- ============================================================================
-- Migration: Modify create_claim_advanced to append to existing active claims
-- ============================================================================
...
BEGIN
    ...
    IF p_rent_ledger_ids IS NOT NULL THEN
        ...
        LOOP
            ...
            -- Prüfen, ob für diese Miete bereits in IRGENDEINEM Claim existiert
            DECLARE
    ...
    IF v_active_claim_id IS NOT NULL THEN
        ...
        VALUES (
            v_user_id, v_new_claim_id, 'note_added', 'Neue Forderungspositionen zur Akte hinzugefügt (' || jsonb_array_length(v_metadata_items) || ')',
            jsonb_build_object(
