-- Migration: Allow settled (bezahlte) claims in the portal to display successful payment screens.
-- Recreate get_public_claim_by_token without rejecting 'settled' status.
