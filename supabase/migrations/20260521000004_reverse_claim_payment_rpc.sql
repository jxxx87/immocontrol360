-- ============================================================================
-- RPC: record_claim_payment (V3)
-- Adds payment_id and old states to event_metadata, and Ref to rent_payments
-- ============================================================================

-- Drop delete protections since user wants to physically delete payments
...
BEGIN
  ...
  -- 10. Insert claim_events (Save state for reversal)
