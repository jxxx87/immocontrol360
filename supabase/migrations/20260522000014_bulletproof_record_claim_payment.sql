-- ============================================================================
-- Migration: Bulletproof record claim payment allocation
-- ============================================================================
...
BEGIN
  ...
  -- Bulletproof defaults if claim_totals_view unexpectedly returns no rows (e.g. edge cases)
  ...
  -- This intercepts any unallocated principal or floating point rounding issues and puts it into fees.
  ...
  IF v_inserted_sum < p_amount THEN
    ...
    -- Reduce alloc_principal for the event metadata if it was over-estimated
