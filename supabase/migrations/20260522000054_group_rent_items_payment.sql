-- Update record_claim_payment to distribute payments across multiple rent ledgers if grouped
...
BEGIN
  ...
  IF p_installment_id IS NOT NULL THEN
    ...
    IF v_inst.plan_claim_id != p_claim_id THEN RAISE EXCEPTION 'Rate geh̦rt nicht hierher.'; END IF;
  END IF;
