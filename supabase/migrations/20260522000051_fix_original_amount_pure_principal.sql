-- ============================================================================
-- Fix: original_amount should ONLY be the principal amount.
-- fee_amount and interest_amount are stored separately on the item.
-- ============================================================================

-- 1. Fix create_claim_advanced
...
BEGIN
    ...
    -- Insert rent items: original_amount = rent ONLY
    IF p_rent_ledger_ids IS NOT NULL THEN
...
-- 2. Fix existing data in claim_items
ALTER TABLE claim_items DISABLE TRIGGER trigger_protect_claim_item_original_amount;

UPDATE claim_items 
SET original_amount = original_amount - fee_amount - interest_amount 
WHERE fee_amount > 0 OR interest_amount > 0;
